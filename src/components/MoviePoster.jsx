...
export const MoviePoster = ({ movie }) => {
  ...
  const isFavorite = useMemo(() => favorites?.some((favorite) => favorite.id === movie.id), [favorites, movie.id]);
  ...
  const addToFavorites = () => {
    ...
    const movieAndType = { ...movie, type: "movie" };
    setFavorites([...favorites, movieAndType]);
    saveFavoritMovies([...favorites, movieAndType]);
